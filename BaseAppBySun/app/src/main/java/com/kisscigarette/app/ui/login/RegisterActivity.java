...
public class RegisterActivity extends Activity implements View.OnClickListener {
    ...
    protected void initView() {
        ...
        registerButton = (LoginButton) findViewById(R.id.btn_register);
        ...
        registerButton.setmListener(new LoginButton.OnSubmitListener() {
            @Override
            public void onclick() {
                closeKeyboard();
                showToast();
    ...
    private void showSuccessDialog(String message) {
        if (successDialog == null) {
            successDialog = new AlertDialog(this).builder()
                    .setMsg(message)
                    .setNegativeButton("注册成功", new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            ...
                            resultIntent.putExtra("register",true);
    ...
    private void showPhoneRegisteredDialog(String message) {
        ...
        if (errorDialog == null) {
            errorDialog = new AlertDialog(this).builder()
                    .setMsg(message)
                    .setPositiveButton("我知道了", 0, new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                        }
                    });
            ...
            registerButton.postDelayed(new Runnable() {
                ...
                public void run() {
                    RetrofitManager.getInstance()
                            ...
                            .loginRegister("", new LoginRequest(phone, pass, true))
                            .subscribeOn(Schedulers.io())
                            .observeOn(AndroidSchedulers.mainThread())
                            .subscribe(new CustomSubscriber<DataResult>(RegisterActivity.this) {
                                           @Override
                                           protected void successResult(DataResult dataResult) {
                                               showSuccessDialog("注册成功");
                                               registerButton.resetButton();
                                           }
