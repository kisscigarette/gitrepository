...
//    private boolean isPassWord;
    ...
    public WholeEditText(Context context, AttributeSet attrs) {
    ...
    public WholeEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mContext = context;
        view = (RelativeLayout) LayoutInflater.from(context).inflate(R.layout.view_show_pass, null);
...
//        textSize = a.getDimensionPixelSize(R.styleable.WholeEditText_textSize, -1);
    ...
    private void initView() {
        ...
        et_pass = (EditText) view.findViewById(R.id.edit_text);
