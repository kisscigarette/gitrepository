...
public class ValideCodeText extends LinearLayout {
    //要显示的view
...
//    private boolean isPassWord;
    ...
    private ValideCodeText.OnTextChangedListener textChangedListener;


    public ValideCodeText.OnTextChangedListener getTextChangedListener() {
        return textChangedListener;
    }

    public void setTextChangedListener(ValideCodeText.OnTextChangedListener textChangedListener) {
        this.textChangedListener = textChangedListener;
    }

    public ValideCodeText(Context context) {
        this(context, null, 0);
        mContext = context;
    }

    public ValideCodeText(Context context, AttributeSet attrs) {
    ...
    public ValideCodeText(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mContext = context;
        view = (RelativeLayout) LayoutInflater.from(context).inflate(R.layout.view_valide_code, null);
...
//        textSize = a.getDimensionPixelSize(R.styleable.WholeEditText_textSize, -1);
    ...
    private void initView() {
        ...
        et_pass = (EditText) view.findViewById(R.id.et_valide);
